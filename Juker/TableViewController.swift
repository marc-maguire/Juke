...
//    
//    @IBOutlet weak var currentTrackLabel: UILabel! //done
//    @IBOutlet weak var currentArtistLabel: UILabel! //done
//    @IBOutlet weak var durationLabel: UILabel! //done
//    //shows as zero before it is set (need to set it when we are transitioning)
//    @IBOutlet weak var timeElapsedLabel: UILabel! //done
//    @IBOutlet weak var trackProgressView: UIProgressView! //done
//    @IBOutlet weak var playbackButton: PlaybackButton! //done
//    
//    @IBOutlet weak var albumArtImageView: UIImageView! //done
//    
//    
//    //MARK: Properties
